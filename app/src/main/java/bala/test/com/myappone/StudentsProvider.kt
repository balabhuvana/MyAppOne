...
class StudentsProvider : ContentProvider() {
    ...
    override fun query(uri: Uri, projection: Array<String>?,
        ...
        val c = qb.query(db, projection, selection,
    ...
    override fun update(uri: Uri, values: ContentValues?,
        ...
        when (uriMatcher.match(uri)) {
            ...
            STUDENT_ID -> count = db!!.update(STUDENTS_TABLE_NAME, values,
    ...
    companion object {
        internal val PROVIDER_NAME = "bala.test.com.myappone.StudentsProvider"
